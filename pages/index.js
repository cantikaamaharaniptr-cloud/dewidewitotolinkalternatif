...
const D = {
  brand: 'DEWIDEWITOTO',
  domain: 'dewidewitotolinkalternatif.com',
  ...
  amphtml: 'dewidewitotolinkalternatif.com',
};
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>DEWIDEWITOTO | Situs Resmi & Login Aman: Zona Bermain Paling Gacor</title>
        <meta name="description" content="Akses DEWIDEWITOTO dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href={D.logo} />
        <link rel="canonical" href={'https://' + D.domain + '/'} />
        <link rel="amphtml" href={'https://' + D.domain + '/amp/'} />
        <meta property="og:title" content="DEWIDEWITOTO | Situs Resmi & Login Aman: Zona Bermain Paling Gacor" />
        <meta property="og:description" content="Akses DEWIDEWITOTO dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna." />
        <meta property="og:image" content={D.logo} />
        <meta property="og:url" content={'https://' + D.domain} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="DEWIDEWITOTO | Situs Resmi & Login Aman: Zona Bermain Paling Gacor" />
        <meta name="twitter:description" content="Akses DEWIDEWITOTO dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna." />
      ...
      <style jsx global>{`
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        body{font-family:'Nunito Sans',sans-serif;background:#200808;color:#e0e0e0;line-height:1.7;overflow-x:hidden}
        a{color:inherit;text-decoration:none}img{max-width:100%;display:block}
        .W{max-width:1200px;margin:0 auto;padding:0 24px}

        .topbar{background:#2e1010;border-bottom:1px solid rgba(229,37,53,.25);padding:7px 0;font-size:12px;color:#ccc}
        .topbar-inner{display:flex;justify-content:space-between;align-items:center}
        .topbar a{color:#e52535;font-weight:700;transition:.2s}.topbar a:hover{opacity:.8}

        header{background:#2e1010;border-bottom:1px solid rgba(229,37,53,.25);position:sticky;top:0;z-index:50;backdrop-filter:blur(12px)}
        .hd{display:flex;align-items:center;justify-content:space-between;padding:12px 0;gap:14px}
        .logo{display:flex;align-items:center;gap:10px;font-weight:900;font-size:24px;color:#e52535;flex-shrink:0}
        .logo img{width:38px;height:38px;border-radius:12px;border:2px solid #e52535}
        ...
        .nav-mid a:hover,.nav-mid a.act{color:#fff;background:#e52535}
        ...
        .btn-p{background:#e52535;color:#fff}.btn-p:hover{background:#cc1f2e;transform:translateY(-1px)}
        .btn-o{border:2px solid #e52535;color:#e52535;background:transparent}.btn-o:hover{background:rgba(229,37,53,.14)}

        .hero{background:#2e1010;padding:50px 0;position:relative;overflow:hidden}
        .hero::before{content:'';position:absolute;right:-150px;top:-80px;width:500px;height:500px;border-radius:50%;background:rgba(229,37,53,.14)}
        .hero::after{content:'';position:absolute;left:-100px;bottom:-120px;width:400px;height:400px;border-radius:50%;background:rgba(229,37,53,.14)}
        .hero-flex{display:flex;align-items:center;gap:44px;position:relative;z-index:1}
        .hero-text{flex:1}
        .hero-text .chip{display:inline-flex;align-items:center;gap:8px;background:#e52535;color:#fff;padding:7px 18px;border-radius:14px;font-size:12px;font-weight:800;margin-bottom:18px;text-transform:uppercase;letter-spacing:.5px}
        ...
        .hero-text .btn-hero.fill{background:#e52535;color:#fff}
        .hero-text .btn-hero.fill:hover{background:#cc1f2e;transform:translateY(-2px);box-shadow:0 10px 28px rgba(0,0,0,.3)}
        .hero-text .btn-hero.line{background:transparent;color:#e52535;border:2px solid #e52535}
        .hero-text .btn-hero.line:hover{background:rgba(229,37,53,.14)}
        ...
        .hero-img img{border-radius:20px;box-shadow:0 24px 64px rgba(0,0,0,.45);border:2px solid rgba(229,37,53,.25)}

        .stats{background:#3c1818;border-top:1px solid rgba(229,37,53,.25);border-bottom:1px solid rgba(229,37,53,.25);padding:26px 0}
        .stats-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;text-align:center}
        .stat-item{padding:8px 0}
        .stat-item .sv{font-size:28px;font-weight:900;color:#e52535}
        .stat-item .sl{font-size:10px;color:#bbb;text-transform:uppercase;letter-spacing:1.5px;margin-top:3px;font-weight:600}

        .sec{padding:56px 0}
        .sec-alt{background:#2e1010}
        .sec-head{text-align:center;margin-bottom:40px}
        .sec-head .badge{display:inline-block;background:#e52535;color:#fff;padding:6px 20px;border-radius:14px;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:1px;margin-bottom:14px}
        ...
        .art-content h3{font-size:22px;font-weight:800;margin-bottom:18px;color:#e52535}
        ...
        .art-gallery img{border-radius:16px;border:2px solid rgba(229,37,53,.25);width:100%;height:210px;object-fit:cover;transition:.3s}
        .art-gallery img:hover{border-color:#e52535;transform:scale(1.02)}
        .art-tags{display:flex;gap:8px;flex-wrap:wrap;margin-top:16px}
        .art-tag{background:#e52535;color:#fff;padding:6px 16px;border-radius:14px;font-size:11px;font-weight:700}

        .feat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px}
        .feat-card{background:#3c1818;border:2px solid rgba(229,37,53,.25);border-radius:20px;padding:28px;transition:.3s}
        .feat-card:hover{border-color:#e52535;transform:translateY(-5px);box-shadow:0 12px 36px rgba(0,0,0,.25)}
        .feat-card .fi-icon{width:52px;height:52px;border-radius:16px;background:rgba(229,37,53,.14);display:flex;align-items:center;justify-content:center;font-size:24px;margin-bottom:16px}
        ...
        .cta-box{background:linear-gradient(135deg,#cc1f2e,#e52535);border-radius:24px;padding:56px 36px;text-align:center;color:#fff;position:relative;overflow:hidden}
        ...
        .cta-box .btn-cta{background:#fff;color:#200808;font-weight:800;padding:16px 38px;border-radius:16px;border:none;cursor:pointer;font-family:inherit;font-size:16px;transition:.25s}
        ...
        .bnr-card{border-radius:16px;overflow:hidden;border:2px solid rgba(229,37,53,.25);transition:.3s}
        .bnr-card:hover{transform:translateY(-4px);box-shadow:0 10px 30px rgba(0,0,0,.25);border-color:#e52535}
        .bnr-card img{width:100%;height:auto}

        .faq-list{max-width:740px;margin:0 auto}
        .faq-item{background:#3c1818;border:2px solid rgba(229,37,53,.25);border-radius:16px;padding:20px 24px;margin-bottom:10px;cursor:pointer;transition:.25s}
        .faq-item:hover{border-color:#e52535}
        .faq-q{font-weight:700;display:flex;justify-content:space-between;align-items:center;font-size:15px;color:#f0f0f0}
        .faq-q span{color:#e52535;font-size:20px;font-weight:800}
        .faq-a{margin-top:12px;color:#bbb;font-size:14px;line-height:1.75;border-top:1px solid rgba(229,37,53,.25);padding-top:12px;text-align:justify}

        footer{background:#2e1010;border-top:2px solid rgba(229,37,53,.25);padding:40px 0;font-size:13px}
        .ft-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:30px;margin-bottom:24px}
        .ft-col h4{color:#e52535;font-size:15px;font-weight:800;margin-bottom:14px}
        .ft-col a{display:block;color:#aaa;margin-bottom:8px;transition:.2s;font-weight:500}.ft-col a:hover{color:#e52535}
        .ft-bottom{border-top:1px solid rgba(229,37,53,.25);padding-top:20px;text-align:center;color:#999}
        ...
        <section className="hero"><div className="W">
          <div className="hero-flex">
            <div className="hero-text">
              ...
              <h1>DEWIDEWITOTO | Situs Resmi & Login Aman: Zona Bermain Paling Gacor</h1>
              <p>Akses DEWIDEWITOTO dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna.</p>
              <div className="hbtns">
        ...
        <section className="sec sec-alt" id="tentang"><div className="W">
          ...
          <div className="art-row">
            <div className="art-content">
              ...
              <p>DEWIDEWITOTO di situs resmi DEWIDEWITOTO dibangun di atas fondasi teknologi yang kokoh dan terpercaya. Seperti proyek konstruksi megah yang dikerjakan oleh tenaga ahli, platform DEWIDEWITOTO dirancang oleh tim engineer berpengalaman dengan standar kualitas tertinggi. Setiap lapisan keamanan dibangun dengan presisi, menghasilkan struktur digital yang tahan terhadap berbagai ancaman.</p>
              <div className="art-gallery">
              ...
              <p>Blueprint keunggulan DEWIDEWITOTO melalui situs resmi DEWIDEWITOTO mencakup enkripsi SSL 256-bit sebagai pondasi keamanan, server premium sebagai rangka struktural dengan uptime 99,9%, dan link alternatif sebagai akses darurat yang selalu siap. Tim konstruksi support kami bekerja 24/7, melakukan maintenance dan perbaikan untuk memastikan platform selalu dalam kondisi prima.</p>
